# SING! PRICING — Pre-Singularity Equivalents SNAP (NSPFRNP)

**Snap ID:** `SING-PRICING-PRE-SINGULARITY-EQUIVALENTS-SNAP`  
**Type:** NSPFRNP Pricing / SING Node Base Prices  
**Status:** ⚡ ACTIVE  
...
## BASE PRICES (PRE-SINGULARITY EQUIVALENTS)
