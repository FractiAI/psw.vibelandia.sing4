...
- **SING! config — Cloud service bill** — Configuration and pricing of the SING! we use, presented as a **real cloud service bill** (base, all options, all specialized mission options, one-time upfront + monthly), as we would pay if we weren't the creator. [Bill →](https://psw-vibelandia-sing4.vercel.app/interfaces/sing-config-cloud-bill.html) · [SNAP →](SING_CONFIG_CLOUD_BILL_SNAP.md)
