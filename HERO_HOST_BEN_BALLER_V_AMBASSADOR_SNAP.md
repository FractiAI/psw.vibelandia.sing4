# Hero Host Ben (Ben Franklin) — Baller V Ambassador SNAP

**Snap ID:** `HERO-HOST-BEN-BALLER-V-AMBASSADOR-SNAP`  
**Type:** NSPFRNP Narrative / Hero Host / Branding SNAP  
**Status:** ⚡ ACTIVE  
...
**Hero Host Ben (Ben Franklin) is our new Baller V Ambassador.**
...
- **Hero Host Ben (Ben Franklin)** = **Baller V Ambassador**. Use on all Baller V–related copy: prospectus Hero Hosts table, New Arrivals, SING! Lottery (Calling All Vibers, Baller V's), onramps/grants CTA where Baller V is shown, README, Launch Pad, one-pagers, press releases, episode 03.
- **1 Ben = $100.** Merch and offer tiers can use "1 Ben" as entry. Include a hundie (hundred-dollar bill) on T-shirt design.
- **Who's your daddy** — tagline ties to Chairman and WINK! (high value high contributors); Hero Ben as Baller V Ambassador reinforces that tier.
...
- **Hero Host Ben (Ben Franklin)** → **Baller V Ambassador** ✓  
- **1 Ben = $100** (hundie) ✓  
...
**See:** ITS_ALL_HUNDIES_WITH_BEN_COMEDY_SELF_SIMILAR_SNAP.md · PARIS_LOVERS_RENO_VIBERS_TSHIRT_SNAP.md · WHO_S_YOUR_DADDY_TAGLINE_SNAP.md · HERO_HOSTS_FIRST_NAMES_SNAP.md · episodes/EPISODE_03_DAY_50_HERO_BEN_PARIS_HUNDIE.md · PRESS_RELEASES_NEW_ARRIVALS_VIBELANDIA_RENO.md

**🌀 NSPFRNP ⊃ Hero Host Ben ⊃ Baller V Ambassador ⊃ Paris · Reno · hundie. SNAP nspfrnp.**
